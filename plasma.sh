...
sudo pacman -Syu plasma sddm sddm-kcm plasma-wayland-session plasma-wayland-protocols dolphin ark kcalc kate kdeconnect gwenview haruna okular spectacle ktorrent konsole packagekit-qt5 qt5-imageformats kwalletmanager partitionmanager ffmpegthumbs ffmpegthumbnailer --noconfirm
...
sudo pacman -Rcsn gnome gnome-tweaks gnome-themes-extra gnome-browser-connector file-roller xdg-desktop-portal-gnome python-nautilus fragments celluloid kvantum adw-gtk-theme menulibre --noconfirm
