...
sudo pacman -Syu plasma sddm sddm-kcm plasma-wayland-session plasma-wayland-protocols dolphin ark kcalc kate kdeconnect gwenview haruna okular spectacle konsole packagekit-qt5 qt5-imageformats kwalletmanager merkuro kdepim-addons kio-gdrive partitionmanager ffmpegthumbs ffmpegthumbnailer --noconfirm
sudo pacman -Rsn oxygen plasma-sdk plasma-welcome plasma-workspace-wallpapers --noconfirm
...
sudo pacman -Rcsn gnome gnome-tweaks gnome-themes-extra gnome-browser-connector file-roller xdg-desktop-portal-gnome python-nautilus adw-gtk-theme menulibre celluloid --noconfirm
