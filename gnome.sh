...
sudo pacman -Rsn simple-scan gnome-tour gnome-connections gnome-contacts totem gnome-clocks gnome-maps gnome-music epiphany baobab gnome-user-docs yelp gnome-weather gnome-logs gnome-software snapshot --noconfirm
...
sudo pacman -Rsn plasma sddm sddm-kcm plasma-wayland-session plasma-wayland-protocols dolphin ark kcalc kate kdeconnect gwenview okular spectacle konsole kwalletmanager partitionmanager packagekit-qt5 qt5-imageformats merkuro kio-gdrive kdepim-addons haruna ffmpegthumbnailer ffmpegthumbs --noconfirm
